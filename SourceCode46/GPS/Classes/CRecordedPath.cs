...
namespace AgOpenGPS
{
    ...
    public class CRecordedPath
    {
        ...
        public void UpdatePosition()
        {
            ...
            if (isPausedDrivingRecordedPath) mf.sim.stepDistance = 0 / 35;
        }
        ...
        private void StanleyRecPath(int ptCount)
        {
            ...
            steerAngleRP = Math.Atan((distanceFromCurrentLine * mf.vehicle.stanleyDistanceErrorGain) / ((mf.pn.speed * 0.277777) + 1));
            ...
            mf.guidanceLineDistanceOff = mf.distanceDisplaySteer = (Int16)distanceFromCurrentLine;
