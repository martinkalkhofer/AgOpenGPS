...
#pragma warning disable CS1690 // Accessing a member on a field of a marshal-by-reference class may cause a runtime exception
            tboxCurrentLat.Text = mf.currentLat.ToString();
            tboxCurrentLon.Text = mf.currentLon.ToString();
#pragma warning restore CS1690 // Accessing a member on a field of a marshal-by-reference class may cause a runtime exception
        ...
        private void btnGetSourceTable_Click(object sender, EventArgs e)
        {
            ...
            if (dataList.Count > 0)
            {
                ...
                var form = new FormSource(this, dataList, mf.currentLat, mf.currentLon, syte);
                form.ShowDialog();
            }
            else
            {
